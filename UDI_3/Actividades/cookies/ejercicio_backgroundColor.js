"use strict"
{
    ...
    let colorUsuario = [];
        if (color != "") {
            ...
            miH2.textContent="Bienvenido, Elige un color.";
            document.body.append(miH2);
            colorUsuario[0] = parseInt(prompt("Por favor, Elige un color: (r)", ""));
            colorUsuario[1] = parseInt(prompt("Por favor, Elige un color: (g)", ""));
            colorUsuario[2] = parseInt(prompt("Por favor, Elige un color: (b)", ""));
            let colorFinal = `rgb(${colorUsuario[0]}, ${colorUsuario[1]}, ${colorUsuario[2]})`;
            setCookie("color", colorFinal, 7);
